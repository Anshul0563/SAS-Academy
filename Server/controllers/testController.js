...
const testListFields =
  "title type duration category difficulty tags audioURL createdAt updatedAt";
// ================= CREATE TEST =================
exports.createTest = async (req, res) => {
  try {
    const { title, type, duration, passage, category, tags, difficulty } =
      req.body;
