...
const adminRaw = localStorage.getItem('adminUser') || localStorage.getItem('user');
  const adminUser = adminRaw ? JSON.parse(adminRaw) : {};
  const safeUser = {
    name: adminUser.name || 'Admin',
    totalStudents: adminUser.totalStudents || 0,
    totalTests: adminUser.totalTests || 0
  };
