...
import { Search, UserPlus, Edit3, Trash2, Filter, Users, BarChart3 } from 'lucide-react';
    ...
    <div className="space-y-6 p-6 lg:p-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <motion.button 
          ...
          className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-xl shadow-lg"
        >
      ...
      {/* Filters */}
      <div className="flex flex-col md:flex-row gap-4 bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-4">
        ...
        <select
          ...
          className="px-4 py-2 bg-slate-800/50 border border-slate-700 rounded-xl focus:border-indigo-500 focus:outline-none"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-indigo-500/10 to-indigo-600/10 border border-indigo-500/30 p-6 rounded-2xl">
        ...
        <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-600/10 border border-emerald-500/30 p-6 rounded-2xl">
          <div className="flex items-center gap-3">
        ...
        <div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 border border-orange-500/30 p-6 rounded-2xl">
          <div className="flex items-center gap-3">
                ...
                filteredStudents.map((student, index) => (
                  <tr key={student._id} className="hover:bg-slate-800/30 transition">
                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      <motion.button whileHover={{ scale: 1.05 }} className="p-2 text-slate-400 hover:text-emerald-400 hover:bg-emerald-500/20 rounded-lg transition">
                        <Edit3 size={16} />
                      </motion.button>
                      <motion.button whileHover={{ scale: 1.05 }} className="p-2 text-slate-400 hover:text-red-400 hover:bg-red-500/20 rounded-lg transition">
                        <Trash2 size={16} />
                      </motion.button>
                    </td>
                  </tr>
