...
import { BarChart3, Filter, Download, Calendar, TrendingUp, Award, Users } from 'lucide-react';
        ...
        <motion.div className="bg-gradient-to-r from-orange-500/10 to-orange-600/10 border border-orange-500/30 p-6 rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white">{stats.passRate ? `${stats.passRate}%` : 'N/A'}</p>
            </div>
          </div>
        </motion.div>
      </div>
